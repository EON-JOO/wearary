...
public class activity3_add extends AppCompatActivity {
    EditText editText;
        ...
        findViewById(R.id.completeButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str.length() > 0) {
                    ...
                    String substr = dataformat.format(date);
                    Toast.makeText(activity3_add.this, str + "," + substr, Toast.LENGTH_SHORT).show();
